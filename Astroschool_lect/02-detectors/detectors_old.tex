...
\only<1>{\img[0.86]{allwavesky}}
\only<2>{\img{MWA-whirlpool-galaxy}}
\end{frame}
\begin{frame}
\img{multiwave_galaxy}
\end{frame}
...
\begin{block}{}
Минимальный интервал времени, в течение которого можно обнаружить изменение потока излучения.\\
...
\begin{block}{}Степень детализации изображения зависит от условий наблюдения, оптики телескопа и прибора, размера пикселя.
\end{block}
...
\begin{block}{}
Выходной сигнал всегда отличается от входного: пуассонова статистика фотонов, фон неба, тепловой (темновой) шум, космические частицы, шум считывания и т.п.
...
\end{block}
\col{0.4}\img{hgcdte2}}}
\only<3>{\cols{\col{0.6}\begin{block}{}
...
\only<5>{\cols{\col{0.47}\begin{block}{}
...
\begin{frame}{Обработка ИК-снимков}
