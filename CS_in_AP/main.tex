    ...
    \only<5>{
        \begin{columns}
            ...
            \begin{block}{JWST}25~декабря 2021~года. $D=6.5\,$м, $F=131.4\,$м. Инструменты:
                MIRI (камера среднего ИК), NIRCam (камера ближнего ИК), NIRSpec (спектрограф ближнего ИК), FGS\slash
                NIRISS (датчик точного наведения с бесщелевым спектрографом ближнего ИК).
    ...
    \only<4>{
        \begin{columns}
            ...
            \begin{block}{}
                ...
                Параллаксы до Бесселя (61~Лебедя, 3.5\,пк)~--- 0!
