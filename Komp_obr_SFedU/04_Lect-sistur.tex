...
\title[Компьютерная обработка. Лекция 4.]{Компьютерная обработка результатов
измерений}
\subtitle{Лекция 4. Системы уравнений. Интегрирование. Дифференцирование.}
\date{}
...
$S=\sum_i(\sum_j a_{ij}x_j - b_i)^2$, $\partder{S}{x_j}=0$ \so
$\B C\B x = \B d$, где
